...
const ProductsTable: React.FC = () => {
  return (
    <section className="w-full font-medium mt-6">
      ...
      <div className="border border-[color:var(--Grey-2,#E6E6E6)] bg-white w-full text-sm tracking-[-0.28px] leading-[1.3] rounded-[8px_8px_0px_0px] border-solid">
        {/* Table view on sm+ */}
                ...
                <tr key={product.id} className="border-b border-[#F2F2F2]">
                  ...
                  <td className="px-4 py-4">
                    <div className="flex items-center gap-2">
                      {product.practiceAreas.map((area, idx) => (
                        <span
                          key={idx}
        ...
        <div className="sm:hidden space-y-4 p-4">
          {products.map((product) => (
            ...
            >
              ...
              <div className="flex flex-wrap text-sm text-[#808080] gap-x-4 gap-y-1">
                <div>
                ...
                <div>
                  <span className="font-semibold">Sold Qty:</span>{" "}
